...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'lenmon', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'InternetMemoryCorne', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-zqhiu.vercel.app/', // 网站地址
